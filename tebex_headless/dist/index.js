...
// index.ts
var tebex_headless_exports = {};
__export(tebex_headless_exports, {
  Request: () => Request,
  TebexHeadless: () => TebexHeadless
});
module.exports = __toCommonJS(tebex_headless_exports);
...
async function Request(webstoreIdentifier, privateKey, method, identifier, route, path, params, body) {
  ...
  const response = await import_axios.default.request(config);
